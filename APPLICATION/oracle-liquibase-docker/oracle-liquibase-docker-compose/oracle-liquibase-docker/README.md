...
CMD ["sh", "-c", "docker-entrypoint.sh  --defaultsFile=/liquibase/changelog/liquibase.properties --changeLogFile=changelog/changelog.xml --classpath=/liquibase/changelog:/liquibase/classpath/ojdbc11-21.3.0.0.jar update"]
```
...
```
$  docker run --rm  --name espark-liquibase   --net espark-net   espark/liquibase
####################################################
##   _     _             _ _                      ##
##  | |   (_)           (_) |                     ##
##  | |    _  __ _ _   _ _| |__   __ _ ___  ___   ##
...
##                                                ##
####################################################
Starting Liquibase at 19:45:13 (version 4.8.0 #1581 built at 2022-02-18 21:43+0000)
Liquibase Version: 4.8.0
Liquibase Community 4.8.0 by Liquibase
